...
public class TestProvider extends AndroidTestCase {
    ...
    public void deleteAllRecordsFromProvider() {
        mContext.getContentResolver().delete(
                SpotifyContract.TopTracksEntry.CONTENT_URI,
                null,
                null
        );
        mContext.getContentResolver().delete(
    ...
    public void deleteAllRecordsFromDB() {
        ...
        db.delete(SpotifyContract.TopTracksEntry.TABLE_NAME, null, null);
        db.delete(SpotifyContract.ArtistsEntry.TABLE_NAME, null, null);
        db.close();
    }
    ...
    public void testProviderRegistry() {
        ...
        try {
            ...
            assertEquals("Error: SpotifyProvider registered with authority: " + providerInfo.authority +
...
//        String type = mContext.getContentResolver().getType(SpotifyContract.TopTracksEntry.CONTENT_URI);
//        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
//        assertEquals("Error: the WeatherEntry CONTENT_URI should return WeatherEntry.CONTENT_TYPE",
//                SpotifyContract.TopTracksEntry.CONTENT_TYPE, type);
//
//        String testLocation = "94074";
//        // content://com.example.android.sunshine.app/weather/94074
//        type = mContext.getContentResolver().getType(
//                SpotifyContract.TopTracksEntry.buildWeatherLocation(testLocation));
//        // vnd.android.cursor.dir/com.example.android.sunshine.app/weather
...
//        SQLiteDatabase db = dbHelper.getWritableDatabase();
//
//        ContentValues testValues = TestUtilities.createArtistsContentValues();
